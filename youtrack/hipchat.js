...
(function() {
  var createAddonInterface, createContainer, entryPoint, findProperty, getCompanyKey, linkServices, makePanelInactive, onSettingsLoaded, services, start, taistApi;
  taistApi = null;
  entryPoint = null;
  services = null;
    ...
    for (_i = 0, _len = fields.length; _i < _len; _i++) {
      ...
      switch (elem.type) {
        ...
        case 'password':
          ...
          $('<input>').attr('type', elem.type).attr('name', elem.name).addClass('jt-input').val(findProperty(services.settings, elem.name)).appendTo(div);
      }
