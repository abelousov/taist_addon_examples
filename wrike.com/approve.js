...
(function() {
  var applyStateToInput, applyStateToText, buttonsBar, extractStateFromInput, filtersPanel, getNormalizedStatePrefix, getTitlePrefix, start, states, taistApi, wrikeUtils;
  taistApi = null;
  start = function(_taistApi) {
    taistApi = _taistApi;
    taistApi.hash.useHashchangeEvent = false;
    buttonsBar.renderOnCurrentTaskChange();
    return filtersPanel.renderOnFiltersAppear();
  };
  states = {
    initial: {
      next: ['onApproval'],
  ...
  filtersPanel = {
    ...
    _renderFilter: function(state, filtersPanel) {
      var filter;
