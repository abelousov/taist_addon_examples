...
(function() {
  var allFilters, applyStateToInput, applyStateToText, approver, extractStateFromInput, getTitlePrefix, start, states, taistApi, taistWrike;
  taistApi = null;
    ...
    renderOnFiltersAppear: function() {
      return taistApi.wait.elementRender(this._filtersPanelSelector, (function(_this) {
        return function(filtersPanel) {
          var filter, filtersContainer, state, _, _results;
          if (($('#' + _this._taistFiltersContainerId))[0] == null) {
            ...
            for (_ in states) {
              state = states[_];
              if (state.title != null) {
                filter = _this._renderFilter(state);
    ...
    _renderFilter: function(state, allFilters) {
      ...
      return filter.click((function(_this) {
        return function() {
          ...
          _this._updateFilters(targetState);
          return false;
        };
      })(this));
    },
