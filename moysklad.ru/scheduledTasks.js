...
(function() {
  var Calendar, CalendarSettings, EditableCalendarOptions, InDocCalendar, baseCalendarOptions, calendarDisplay, calendarFactory, calendarStorage, drawGeneralCalendarTab, drawSettingsTab, entryPoint, eventEditDialog, getCompanyKey, init, loadJsLibraries, moyskladUtils, renderGeneralCalendar, start, taistApi, taskStorage, waitDrawDocumentCalendar;
  taistApi = null;
  moyskladUtils = null;
  taskStorage = null;
  entryPoint = null;
  ...
  getCompanyKey = function(cb) {
    return $.get('https://online.moysklad.ru/exchange/rest/ms/xml/MyCompany/list/?count=1').done(function(xml) {
  ...
  eventEditDialog = {
    ...
    _createDialog: function(isNew) {
      var calendarSelect, dialog, nameInput, title;
