...
(function() {
  ...
  CalendarSettings = (function() {
    ...
    CalendarSettings.prototype._renderCalendars = function() {
      var calendar, _i, _len, _ref, _results;
  ...
  eventEditDialog = {
    ...
    _fillCalendarSelect: function(event, calendarSelect) {
      var calendar, selected, _i, _len, _ref, _results;
      _ref = calendarStorage.getOrderedCalendars();
      _results = [];
      for (_i = 0, _len = _ref.length; _i < _len; _i++) {
        calendar = _ref[_i];
        selected = event.calendarId === calendar.id ? "selected" : "";
        _results.push(calendarSelect.append($("<option value=\"" + calendar.id + "\" " + selected + ">" + calendar.name + "</option>")));
      }
      return _results;
    },
  ...
  baseCalendarOptions = {
    ...
    events: function(start, end, unusedTimezone, callback) {
      var event, eventsList, i, ts, _fn, _i, _len;
      ts = new Date().getTime();
      i = 0;
    ...
    EditableCalendarOptions.prototype._bindPublicMethods = function() {
      ...
      for (propName in self) {
        ...
        if (propName[0] !== "_" && typeof propValue === "function") {
          _results.push((function(propName, propValue) {
  ...
  Calendar = (function() {
    ...
    Calendar.prototype._renderCalendarDisplayFlags = function() {
      var calendar, flagsContainer, self, _fn, _i, _len, _ref;
      self = this;
  ...
  projectsStorage = {
    ...
    getProjectColor: function(uuid) {
      var color, colorNum, _ref;
      if (!((_ref = this._projectsData[uuid]) != null ? _ref.color : void 0)) {
  ...
  moyskladUtils = {
    ...
    api: {
      ...
      _resolveProjectUuidCallbacks: function(uuid) {
        ...
        while (this._uuidToProjectUuid[uuid].callbacks.length > 0) {
          ...
          _results.push(callback(this._uuidToProjectUuid[uuid].projectUuid));
        }
        return _results;
      },
    ...
    uiPrimitives: {
      ...
      button: function(options) {
        var button, buttonDecorator, icon, styles, _ref;
        buttonDecorator = this._getButtonDecoratorsByTypes()[(_ref = options.type) != null ? _ref : "button"];
