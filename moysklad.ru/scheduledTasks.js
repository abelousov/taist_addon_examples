...
(function() {
  var Calendar, CalendarSettings, InDocCalendar, calendarStorage, drawGeneralCalendarTab, drawSettingsTab, entryPoint, getCompanyKey, init, loadFullCalendar, moyskladUtils, renderGeneralCalendar, start, taistApi, taskStorage, waitDrawDocumentCalendar;
  taistApi = null;
  moyskladUtils = null;
  taskStorage = null;
  entryPoint = null;
  ...
  init = function(callback) {
    ...
    return taistApi.wait.once((function() {
      ...
      return calendarStorage.init(function() {
        return taskStorage.init(callback);
      });
    });
  };
