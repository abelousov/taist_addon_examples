...
(function() {
  var componentsDropdown, createIssueForm, editIssueForm, githubUtils, issuesList, settingsForm, start, storage, utils;
  utils = null;
  ...
  githubUtils = {
    ...
    createDropdown: function(caption, listCaption, options) {
      var addOption, changeHandler, currentValue, dropdownContents, itemsByValues, itemsList, opt, _i, _len;
